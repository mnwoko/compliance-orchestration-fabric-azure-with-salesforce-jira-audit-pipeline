...
🏗️ Architecture
The system utilizes a Triple-Table Model within a Fabric Lakehouse and Warehouse environment:
sf_accounts: The "Source of Truth" containing corporate identity data (Email, IsActive status).
raw_jira_users_list: The operational state showing who currently has access to DevOps environments.
audit_history: A temporal table storing historical snapshots for forensic review.
...
# 🚀 End-to-End Compliance Orchestration: Scaling Salesforce-Jira Identity Audits with Microsoft Fabric and Azure ADLS Gen2
